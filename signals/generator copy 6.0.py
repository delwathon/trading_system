...
class SignalGenerator:
    ...
    def __init__(self, config: EnhancedSystemConfig, exchange_manager=None):
        ...
        self.logger.info("✅ ENHANCED Signal Generator v6.0 initialized")
        ...
        self.logger.info(f"   Take Profit: TP1 Market-based, TP2 {self.signal_config.tp2_multiplier}x")
        self.logger.info(f"   RSI Thresholds: Long < {self.signal_config.max_rsi_for_long}, Short > {self.signal_config.min_rsi_for_short}")
